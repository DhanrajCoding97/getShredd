    ...
    Xi.exports = (function () {
        ...
        return function (t, r) {
            ...
            var a = 0,
                ...
                U = [];
            for (l = 0; l < i; l++)
                (U.push(l + 1), U.push(t.charCodeAt(s + l)));
...
function Sd(e, t = ha) {
    ...
    if (e < 0)
        throw new Ce(Ae.EncodeTimeNegative, `Time must be positive: ${e}`);
...
\`\`\``
            : '',
        c =
            De(`Hi Prisma Team! My Prisma Client just crashed. This is the report:
## Versions
...
${n.backtrace}`,
    ...
    async request(t, { interactiveTransaction: r, customDataProxyFetch: n }) {
        ...
        if (cl(t)) s = pl(t);
            ...
            let { parameterizedQuery: l, placeholderValues: u } = ii(
                    t,
                    this.#o,
                ),
                c = JSON.stringify(l);
    ...
    async requestBatch(t, { transaction: r, customDataProxyFetch: n }) {
        ...
        if (c) p = this.#g(t, a, u);
            ...
            let { parameterizedBatch: m, placeholderValues: g } = oi(
                    s,
                    this.#o,
                ),
                x = JSON.stringify(m);
...
var di =
        ...
        (r) => {
            ...
            if (mr(r))
                ...
                let [o, ...s] = r;
                ((n = o),
                    (i = { values: tt(s || []), __prismaRawParameters__: !0 }));
            } else
                switch (t) {
                    case 'sqlite':
                    case 'mysql': {
    ...
    zr = class {
        ...
        handleRequestError({
            ...
            if (
                ...
                if (t.isPanic)
                    throw new b.PrismaClientRustPanicError(
                        l,
