        ...
        h = class e extends Uint8Array {
            ...
            toString(t = 'utf8', r = 0, n = this.length) {
                if (
                    ...
                    return '';
                if (t === 'utf8' || t === 'utf-8')
                    return zl.decode(this.slice(r, n));
                if (t === 'base64' || t === 'base64url') {
...
function ao(e, t) {
    ...
    if (
        ...
        for (
            i = m.length, a = S.length, T = i < a, T && (a = i), i = 0;
            i < a;
            i++
        )
            if (m[i] != S[i]) {
    ...
    co = xe(() => {
        ...
        C.toPrecision = function (e, t) {
            ...
            return (
                e === void 0
                    ? ((r = z(i)),
                      (n = ze(i, r <= o.toExpNeg || r >= o.toExpPos)))
                    : (Te(e, 1, at),
                      t === void 0 ? (t = o.rounding) : Te(t, 0, 8),
                      (i = _(new o(i), e, t)),
                      (r = z(i)),
...
var Qn = ue((Tb, Bo) => {
    ...
    Bo.exports = (function () {
        ...
        return function (t, r) {
            ...
            for (; a < o; )
                for (
                    I = r.charCodeAt(s + (f = a)), A = ++a, m = 0;
                    m < Qe;
                    m += 2
                )
                    ((N = oe[m]),
                        (oe[m] = A = e(N, f, A, I, oe[m + 1])),
                        (f = N));
            return A;
        };
    })();
...
function _d(e, t = ou) {
    ...
    if (e < 0)
        throw new rt(tt.EncodeTimeNegative, `Time must be positive: ${e}`);
    ...
    async interpretNode(t, r) {
        switch (t.type) {
            ...
            case 'sum': {
                ...
                return {
                    value: n.length > 0 ? n.reduce((i, o) => Ae(i) + Ae(o)) : 0,
                };
            }
            case 'execute': {
...
var cn = class {
    ...
    #l(t, r, n) {
        ...
        if (Re(n, Ce.ParamEnum)) {
            ...
            if (
                i &&
                t.every((o) => typeof o == 'string' && Object.hasOwn(i, o))
            ) {
...
async function fm() {
    return (
        globalThis.crypto ?? (await Promise.resolve().then(() => (We(), Fn)))
    );
}
async function Ru() {
...
\`\`\``
            : '',
        T =
            pt(`Hi Prisma Team! My Prisma Client just crashed. This is the report:
## Versions
...
${n.backtrace}`,
    ...
    async request(t, { interactiveTransaction: r, customDataProxyFetch: n }) {
        ...
        if (Ku(t)) s = Zu(t);
            ...
            let { parameterizedQuery: m, placeholderValues: f } = Fi(
                    t,
                    this.#o,
                ),
                T = JSON.stringify(m);
    ...
    async requestBatch(t, { transaction: r, customDataProxyFetch: n }) {
        ...
        if (T) S = this.#g(t, a, f);
            ...
            let { parameterizedBatch: A, placeholderValues: N } = $i(
                    s,
                    this.#o,
                ),
                R = JSON.stringify(A);
                    ...
                    if (r?.kind !== 'itx') {
                        let I = r?.options,
                            J = {
                                maxWait:
                                    I?.maxWait ??
                                    this.config.transactionOptions.maxWait,
                                timeout:
                                    I?.timeout ??
                                    this.config.transactionOptions.timeout,
                                isolationLevel:
                                    I?.isolationLevel ??
                                    this.config.transactionOptions
                                        .isolationLevel,
...
var Ji =
        ...
        (r) => {
            ...
            if (Qr(r))
                ...
                let [o, ...s] = r;
                ((n = o),
                    (i = { values: Nt(s || []), __prismaRawParameters__: !0 }));
            } else
                switch (t) {
                    case 'sqlite':
                    case 'mysql': {
...
`,
        ...
        async _transactionWithCallback({ callback: n, options: i = {} }) {
            ...
            try {
                ...
                for (let J = 0; J < I; J++)
                    await this._engine
                        .transaction('rollback', T, v)
                        .catch((j) => {
                            Dt(
                                'rollback attempt %d/%d failed: %O',
                                J + 1,
                                I,
                                j,
                            );
